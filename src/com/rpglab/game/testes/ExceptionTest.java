...
public class ExceptionTest {
    ...
    void testNotEnoughResourceException() {
        Hero hero = new Hero("Hero", 100, 20, 0.5) {
            @Override
            public void useSpecialSkill(com.rpglab.game.characters.Character target) throws NotEnoughResourceException {
                if (target == null) {
        ...
        Exception exception = assertThrows(NotEnoughResourceException.class, () -> {
            hero.useSpecialSkill(null); // Simula falta de recursos
        });
